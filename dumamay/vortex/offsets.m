...
void set_n61ap_10_2_1() {
    ...
    // (old dumamay): 0x01b004000 (dumamay calculated base) - 0x0060C8000 (base) = 0x14F3C000
    // (new dumamay): 0x007004000 (text) + 14000000 (slide) = 0x1B004000 (dumamay calculated base)
...
//            set_d101ap_10_2_1();
        ...
        if(strstr("N61AP", model)) { // iPhone 6 - N61AP
            ...
            NSLog(@"[dumamay]: iPhone 6 running iOS 10.3.1 -- not tested!\n");
            //set_n61ap_10_3_1();
            ret = KERN_FAILURE;
